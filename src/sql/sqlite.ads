...
--  Licence : Gpl v2                               Luebeck            --
--  Winter, 2009                  Last revision :  14:47 31 Oct 2019  --
--
--  Minimal binding to SQLite 3.x.
--
--  20211216 - sr - Text and Blob definitions are inverted
--  20211217 - sr - Reformatting
...
package SQLite is
   ...
   -- 20211216 - sr
   -- Text and Blob definitions are inverted
   -- SQLITE_BLOB    : constant Datatype := 3;
   -- SQLITE_TEXT    : constant Datatype := 4;

   SQLITE_TEXT    : constant Datatype := 3;
   SQLITE_BLOB    : constant Datatype := 4;
...
------------------------------------------------------------------------
   ...
   -- The type encapsulating a SQLite data base
...
--
   ...
   procedure Bind (Command : Statement; Parameter : Positive; Value : double);
   procedure Bind (Command : Statement; Parameter : Positive; Value : int);
   procedure Bind (Command : Statement; Parameter : Positive; Value : Integer_64);
   procedure Bind (Command : Statement; Parameter : Positive; Value : String);
   procedure Bind (Command : Statement; Parameter : Positive; Value : Stream_Element_Array);
   procedure Bind (Command : Statement; Parameter : Positive; Value : access String);
   procedure Bind (Command : Statement; Parameter : Positive; Value : access Stream_Element_Array);
   procedure Bind (Command : Statement; Parameter : Positive; Value : chars_ptr; Length : size_t);
   procedure Bind (Command : Statement; Parameter : Positive);
...
--
   ...
   function Column (Command : Statement; Position : Positive) return double;
   function Column (Command : Statement; Position : Positive) return int;
   function Column (Command : Statement; Position : Positive) return Integer_64;
   function Column (Command : Statement; Position : Positive) return String;
   function Column (Command : Statement; Position : Positive) return Stream_Element_Array;
...
--
   ...
   function Column_Type (Command  : Statement; Position : Positive) return Datatype;
...
--
   ...
   function Filename (Base : Data_Base; Name : String := "main") return String;
...
--
   ...
   function Is_Null (Command : Statement; Position : Positive) return Boolean;
...
--
   ...
   function Prepare (Base : Data_Base'Class; Command : String) return Statement;
...
--
   ...
   procedure Step (Object : Backup; Pages : int := -1);
...
type On_Close is access procedure (User_Data : Object.Entity_Ptr);
...
procedure Set_User_Data (  Base : Data_Base; Data : Object.Entity_Ptr);
