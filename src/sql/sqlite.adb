...
--
--  20211214 - sr - Avoid dependency with Strings_Edit.Integers and related packages

with Ada.Exceptions;         use Ada.Exceptions;
with Ada.IO_Exceptions;      use Ada.IO_Exceptions;

-- 20211214 - sr
-- Avoid dependency with Strings_Edit.Integers and related packages
-- strings_edit.adb  strings_edit-integer_edit.adb  strings_edit-integers.ads
-- strings_edit.ads  strings_edit-integer_edit.ads  strings_edit-text_edit.adb
...
package body SQLite is
   ...
   procedure Check (Connection : SQLite_Handle; Result : int) is
      function Message return String is
         ...
         Code : constant String := '[' & Interfaces.C.int'Image (Result) & ']';
